  ...
  if (servicesError || doctorsError) {
    return (
      <div className="p-8 text-red-600">
        Error loading data: {servicesError?.message || doctorsError?.message}
      </div>
    );
  }
            ...
            <div className="grid md:grid-cols-3 gap-8 relative">
              ...
              <div className="text-center relative">
                ...
                <p className="text-gray-600 text-sm">
                  before you make an appointment you are required to choose
                  disease and doctor
                </p>
              </div>
              ...
              <div className="text-center relative">
                ...
                <p className="text-gray-600 text-sm">
                  once you are registered you can make an appointment with the
                  doctor via the online form.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">
                  after that you can meet with the doctor and consult about your
