      ...
      <div className="p-4 md:p-6 lg:p-8">
        <div className="bg-white rounded-xl shadow-sm">
          <div className="p-4 md:p-6">
            <div className="font-semibold text-lg md:text-xl text-gray-800 mb-4">Doctor's Rating</div>
            ...
            <div className="md:hidden space-y-4">
              <AppointmentCardList
                ...
                extraAction={(a) =>
                  a.status === "Completed" ? (
                    <button
                      className="w-full bg-gray-500 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-blue-600 transition cursor-pointer"
