        ...
        <div className="w-full py-16 px-4">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="text-center mb-12">
                    ...
                    <h2 className="text-3xl md:text-4xl font-bold text-gray-900">{doctor.title}</h2>
                </div>

                {/* chambers with Flexbox */}
                <div className="flex flex-col md:flex-row flex-wrap justify-center gap-8">
                    {doctor.doctorField.chamber?.nodes.map((specialty) => (
                        <div
                            key={specialty.id}
                            ...
                            <div className="w-52 h-52 rounded-full border border-gray-400 bg-white flex items-center justify-center mb-6">
                                ...
                                <div className="w-44 h-44 rounded-full shadow-md overflow-hidden relative">
                                    <Image
                                        ...
                                        alt={specialty.name || "chamber"}
                                        fill
                                        className="object-cover"
                                    />
                                </div>
                            </div>
                            <h3 className="text-lg font-semibold text-center mb-3">{specialty.title}</h3>
